...
namespace VivenciarGenerateOrder.Infra.Map
{
    public class PatientMap : IEntityTypeConfiguration<Patient>
    {
        ...
        {
            builder.Property(x => x.Id).HasColumnName("PatientId").ValueGeneratedNever().IsRequired();
            ...
            builder.Property(x => x.NationalRegister).HasColumnType("VARCHAR(11)").IsRequired();
